...
import Authenticate from '../../components/videoSystem/Authenticate';
      ...
      {user ? (
        <Container darkMode={darkMode}>
          ...
          <form id="main-info" onSubmit={mainInfoForm.handleSubmit}>
            ...
            <div id="form">
              ...
              <div id="inputs">
                ...
                />
                {mainInfoForm.errors.username &&
                  mainInfoForm.touched.username && (
                    <p className="error">{mainInfoForm.errors.username}</p>
                  )}
                <input
                  type="email"
                  name="email"
                  ...
                  onBlur={mainInfoForm.handleBlur}
                />
                {mainInfoForm.errors.email && mainInfoForm.touched.email && (
                  <p className="error">{mainInfoForm.errors.email}</p>
                )}
              </div>
            </div>
            <Button
              mode="form"
              text={mainInfoLoading ? <InlineLoader /> : 'Save'}
            />
          </form>
          <form id="security" onSubmit={securityForm.handleSubmit}>
            ...
            <div id="form">
              ...
              {securityForm.errors.newPassword &&
                securityForm.touched.newPassword && (
                  <p className="error">{securityForm.errors.newPassword}</p>
                )}
              <input
                type="password"
            ...
            <Button
              mode="form"
              text={securityLoading ? <InlineLoader /> : 'Save'}
            />
          </form>
          <div id="danger-zone">
            <h2>Danger Zone</h2>
            <Button
              ...
              onClick={async () => {
                try {
                  ...
                  setAlert({
                    type: 'failure',
                    text: 'Error occured deleting account! Try again later',
                  });
                  setTimeout(() => setAlert(null), 5000);
                }
              }}
